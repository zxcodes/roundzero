/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2cd8583680431a172325b252392b6b0c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		INTERVIEW_AGENT: DurableObjectNamespace<import("./src/worker").InterviewAgent>;
		PRE_EVALUATION: Workflow<Parameters<import("./src/worker").PreEvaluationWorkflow['run']>[0]['payload']>;
		POST_EVALUATION: Workflow<Parameters<import("./src/worker").PostEvaluationWorkflow['run']>[0]['payload']>;
	}
}
