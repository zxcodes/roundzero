/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e95a8afcd6eb440a2559ef18fd9b35cf)
// Runtime types generated with workerd@1.20260301.1 2026-04-23 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		INTERVIEW_AGENT: DurableObjectNamespace<import("./src/index").InterviewAgent>;
		PRE_EVALUATION: Workflow<Parameters<import("./src/index").PreEvaluationWorkflow['run']>[0]['payload']>;
		REPORT_GENERATION: Workflow<Parameters<import("./src/index").ReportGenerationWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_URL" | "EDGE_WORKER_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN">> {}
}
