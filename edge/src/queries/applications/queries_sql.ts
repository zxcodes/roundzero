...
): Promise<createApplicationRow | null> {
  const rows = await sql
    .unsafe(createApplicationQuery, [
      args.jobId,
      args.candidateId,
      args.resumeKey,
      args.metadata,
...
export async function getApplicationByJobAndCandidate(
  sql: Sql,
  args: getApplicationByJobAndCandidateArgs,
): Promise<getApplicationByJobAndCandidateRow | null> {
  const rows = await sql
    .unsafe(getApplicationByJobAndCandidateQuery, [args.jobId, args.candidateId])
    .values();
  if (rows.length !== 1) {
    return null;
  }
...
export async function getApplicationsByCandidate(
  sql: Sql,
  args: getApplicationsByCandidateArgs,
): Promise<getApplicationsByCandidateRow[]> {
  return (await sql.unsafe(getApplicationsByCandidateQuery, [args.candidateId]).values()).map(
    (row) => ({
      id: row[0],
      jobId: row[1],
      candidateId: row[2],
...
export async function getApplicationsByJob(
  sql: Sql,
  args: getApplicationsByJobArgs,
): Promise<getApplicationsByJobRow[]> {
...
): Promise<getApplicationByIdRow | null> {
...
export async function getApplicationReviewById(
  sql: Sql,
  args: getApplicationReviewByIdArgs,
): Promise<getApplicationReviewByIdRow | null> {
...
): Promise<updateApplicationStatusRow | null> {
...
export async function getApplicationCountByJob(
  sql: Sql,
  args: getApplicationCountByJobArgs,
): Promise<getApplicationCountByJobRow | null> {
...
export async function countApplicationsByCompany(
  sql: Sql,
  args: countApplicationsByCompanyArgs,
): Promise<countApplicationsByCompanyRow | null> {
...
export async function countApplicationsByCandidate(
  sql: Sql,
  args: countApplicationsByCandidateArgs,
): Promise<countApplicationsByCandidateRow | null> {
