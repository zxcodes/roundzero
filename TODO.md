...
- check how batch config is working and if it's respecting the no of reports a company selects for a job application. also check if the batch stops after reaching the target size.
