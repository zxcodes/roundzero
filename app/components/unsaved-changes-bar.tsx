    ...
    <ClientOnly fallback={null}>
      {createPortal(
        <div className="pointer-events-none fixed inset-x-4 bottom-4 z-30 md:left-[calc(var(--sidebar-width)+1rem)] md:right-6 lg:left-[calc(var(--sidebar-width)+1.5rem)]">
          <div className="pointer-events-auto mx-auto flex w-full items-center justify-between gap-4 rounded-2xl border border-border/70 bg-background/92 px-4 py-3 shadow-[0_18px_48px_-24px_rgba(0,0,0,0.72)] ring-1 ring-background/80 backdrop-blur-xl">
