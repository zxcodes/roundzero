/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a1822798a04310ddde356c77424d9b33)
// Runtime types generated with workerd@1.20260426.1 2026-04-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "InterviewAgent";
	}
	interface Env {
		RESUMES: R2Bucket;
		AI: Ai;
		...
		INTERVIEW_AGENT: DurableObjectNamespace<import("./worker").InterviewAgent>;
		PRE_EVALUATION: Workflow<Parameters<import("./worker").PreEvaluationWorkflow['run']>[0]['payload']>;
		POST_EVALUATION: Workflow<Parameters<import("./worker").PostEvaluationWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_URL" | "EDGE_WORKER_SECRET" | "APP_URL" | "CLOUDFLARE_ACCOUNT_ID" | "AI_GATEWAY_ID" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL">> {}
}
