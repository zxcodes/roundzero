  ...
  beforeLoad: ({ context }) => {
    if (context.user) {
      if (context.user.role === "candidate") {
        // Wrong login page — redirect to candidate dashboard with a hint
      ...
      <div className="animate-fade-in-up relative w-full max-w-sm space-y-8 text-center">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold tracking-tight">Hire smarter</h1>
        ...
        <p className="text-xs text-muted-foreground">
          ...
          <a href="/candidate/login" className="text-primary hover:underline">
