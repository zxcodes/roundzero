...
function TermsPage() {
  return (
    <LegalPage title="Terms of Service" crossLink={{ to: "/privacy", label: "Privacy Policy" }}>
      <LegalSection title="1. Acceptance of Terms">
        <p>
          By accessing or using RoundZero ("the Service"), you agree to be bound by these Terms of
          Service. If you do not agree to these terms, you may not access or use the Service. These
          terms apply to all visitors, users, and others who access or use the Service, including
          both companies posting jobs and candidates applying for positions.
        </p>
      </LegalSection>

      <LegalSection title="2. Description of Service">
        <p>
          RoundZero is a hiring platform that enables companies to post job openings and candidates
          to apply for those positions. Our Service includes AI-driven asynchronous interviews,
          candidate evaluation, structured reporting, and application tracking. The Service is
      ...
      <LegalSection title="3. User Accounts">
        <p>
          When you create an account with RoundZero, you must provide information that is accurate,
        ...
        <p>
          You are responsible for safeguarding the authentication credentials that you use to access
          the Service. You agree not to disclose your credentials to any third party. You must
      ...
      <LegalSection title="4. User Types and Responsibilities">
        <p>
          <LegalStrong>For Companies:</LegalStrong> You represent that you have the authority to
          post jobs on behalf of your organization. All job postings must be accurate, lawful, and
          not discriminatory. You are responsible for complying with all applicable employment laws
          and regulations in your jurisdiction.
        </p>
        <p>
          <LegalStrong>For Candidates:</LegalStrong> You represent that all information in your
          profile, resume, and applications is truthful and accurate. You grant RoundZero the right
          to share your application materials with the companies to which you apply. You understand
          that your profile and resume may be evaluated by our AI systems as part of the application
          process.
        </p>
      </LegalSection>
      ...
      <LegalSection title="5. Content and Intellectual Property">
        <p>
          ...
          non-exclusive, royalty-free license to use, modify, and display that content solely for
          the purpose of operating and improving the Service.
        </p>
        <p>
          The Service and its original content (excluding content provided by users), features, and
          functionality are and will remain the exclusive property of RoundZero. The Service is
          protected by copyright, trademark, and other laws.
        </p>
      </LegalSection>

      <LegalSection title="6. AI Interviews and Evaluations">
        <p>
        ...
        <p>
          We strive for fairness and transparency in our AI evaluations. Reports include explainable
          reasoning for scores and recommendations. However, AI evaluations are assistive tools and
      ...
      <LegalSection title="7. Prohibited Activities">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>Discriminate against candidates or employees based on protected characteristics</li>
      ...
      <LegalSection title="9. Limitation of Liability">
        <p>
          To the maximum extent permitted by law, RoundZero shall not be liable for any indirect,
        ...
        <p>
          ...
          shall not exceed the amount you paid to RoundZero in the twelve (12) months preceding the
      ...
      <LegalSection title="11. Governing Law">
        <p>
          ...
          arising from these Terms shall be resolved in the courts located in Delaware.
        </p>
      </LegalSection>
      ...
      <LegalSection title="12. Changes to Terms">
        <p>
          ...
          will provide at least 30 days' notice before the new terms take effect. Your continued use
