...
function ApplicantAiReportPage() {
  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <div className="flex items-start gap-3 rounded-3xl border border-border/70 bg-card p-5 shadow-sm">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h1 className="mt-1 text-xl font-semibold tracking-tight">{application.candidateName}</h1>
          <p className="text-sm text-muted-foreground">
            Reviewing for{" "}
            <span className="font-medium text-foreground">{application.jobTitle}</span> · Report
            generated by Zero
          </p>
        </div>
      </div>
