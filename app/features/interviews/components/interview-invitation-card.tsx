...
export function InterviewInvitationCard({
  ...
  return (
    <Card className="brand-glow border border-brand/10 bg-[radial-gradient(circle_at_top_left,var(--brand)/10,transparent_32%),var(--color-card)] shadow-lg shadow-brand/10">
