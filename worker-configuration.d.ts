/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: 10d7cc5d8decf29c241e9434ee9c1581)
// Runtime types generated with workerd@1.20260801.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	RESUMES: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	EMAIL: SendEmail;
	AI: Ai;
	MATCH_DIGEST_ENABLED: "true" | "false";
	NODE_ENV: string;
	DATABASE_URL: string;
	...
	VITE_APP_URL: string;
	APP_URL: string;
	VITE_PUBLIC_ASSET_BASE_URL: string;
	EMAIL_FROM: string;
	...
	VoiceAssessmentAgent: DurableObjectNamespace<import("./app/server").VoiceAssessmentAgent>;
	...
	POOL_CHECK: Workflow<Parameters<import("./app/server").PoolCheckWorkflow['run']>[0]['payload']>;
	EVAL_RETRY: Workflow<Parameters<import("./app/server").EvalRetryWorkflow['run']>[0]['payload']>;
	ACCOUNT_CLEANUP: Workflow<Parameters<import("./app/server").AccountCleanupWorkflow['run']>[0]['payload']>;
	JOB_MATCHING: Workflow<Parameters<import("./app/server").JobMatchingWorkflow['run']>[0]['payload']>;
	MATCH_RECONCILIATION: Workflow<Parameters<import("./app/server").MatchReconciliationWorkflow['run']>[0]['payload']>;
	MATCH_DIGEST: Workflow<Parameters<import("./app/server").MatchDigestWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MATCH_DIGEST_ENABLED" | "NODE_ENV" | "DATABASE_URL" | "TEST_DATABASE_URL" | "SESSION_SECRET" | "VITE_GOOGLE_CLIENT_ID" | "VITE_APP_URL" | "APP_URL" | "VITE_PUBLIC_ASSET_BASE_URL" | "EMAIL_FROM" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "POLAR_MODE" | "POLAR_PRODUCT_ID_STARTER" | "POLAR_PRODUCT_ID_GROWTH" | "POLAR_PRODUCT_ID_SCALE" | "CLOUDFLARE_ACCOUNT_ID" | "AI_GATEWAY_ID" | "AI_GATEWAY_TOKEN" | "OPENROUTER_API_KEY" | "PLATFORM_ADMIN_EMAILS" | "SENTRY_AUTH_TOKEN">> {}
}
